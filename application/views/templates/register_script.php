...
$(document).ready(function (){
	//$("#lumixpurchase_1").mask("99-99-9999");
	$("#mob_no").mask("99 9999 9999");

	var mailexisturl = "<?php echo base_url('users/check-email'); ?>";
	...
	var validation = jQuery("#applyNowForm").validate({
      	...
      	messages: {
			'lumixcam[0]':{
				required: "Select camera/lens field",
			},
			'lumixeligi[0]':{
				required: "Select eligibility field",
			},
			'lumixserial[0]':{
		    ...
		    $.ajax({
	            ...
	            success:function(resp){
	                ...
	                if(resp_data.length <= 0) {
				    	...
				    	$('.eligible-message').html('<div class="alert alert-danger" style="background-color: #f2dede;font-size: 13px;"><b class="eligible-message-error"><i class="fa fa-remove fa-lg eligible-message-error-icon" ></i>  You are not eligible. Please enter all your gear as this will help to determine if you are eligible for membership.</b></div>');
				    	// setTimeout(function(){
		                //     $( ".lumix-detail-error" ).remove();
		                // }, 20000);
				    } else if(resp_data.length === 1) {
                        nextTab(active);
                        $('.eligible-message').html('<div class="alert alert-success" style="background-color: #dff0d8;font-size: 13px;"><b class="eligible-message-success"><i class="fa fa-check fa-lg eligible-message-success-icon" ></i>  You are eligible for ' + resp_data[0].membership + ' membership. Please enter all your gear as this will help to provide you with all your available membership level options.</b></div>');
                    } else {
                        nextTab(active);
                        $('.eligible-message').html('<div class="alert alert-success" style="background-color: #dff0d8;font-size: 13px;"><b class="eligible-message-success"><i class="fa fa-check fa-lg eligible-message-success-icon" ></i>  You are eligible for both Silver and Platinum membership. Please enter all your gear as this will help to provide you with all your available membership level options.</b></div>');
                        // setTimeout(function(){
                        //     $( ".lumix-detail-error" ).remove();
                        // }, 20000);
                    }
...
//<div class="col-md-3"><div class="form-group"><input type="text" name="purchase_date['+y+']" class="form-control lumixpurchase" id="lumixpurchase_'+x+'" value="" placeholder="Purchase Date* YYYY-MM-DD"></div></div>
           ...
           // $('#lumixpurchase_'+x+'').mask("99-99-9999");
